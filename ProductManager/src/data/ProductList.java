...
public class ProductList extends ArrayList<Product>{
    ...
    public void searchProduct(){
        String find = MyTool.readNonBlank("Enter product name: ");
    ...
    public void addProduct(){
        ...
        int pos;
        do {
            productID = MyTool.readPattern("ID of new Product, format [P000]", Product.ID_FORMAT, "Invalid format");
        ...
        do {
            productName = MyTool.readPattern("Name of new Product", Product.PRODUCT_FORMAT,  "Name of product must be at least 5 characters and contains no spaces");
    ...
    public void checkExistProduct(){
        boolean check = false;
        String find = MyTool.readNonBlank("Enter product name you want to check");
        for (Product p: this){
    ...
    public void updateProduct(){
        ...
        String productID = MyTool.readNonBlank("Enter ID of product that needs updating");
    ...
    public void deleteProduct() {
        String productID = MyTool.readNonBlank("Enter ID of product needs removing");
        int pos = checkID(productID);
        if (pos < 0) {
